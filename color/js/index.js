...
const animationContainer = document.querySelector('.anim-text1');
...
// Animate on enter key
animationContainer2.addEventListener('keydown', function(e) {
	switch(e.keyCode) {
		case 13:
			e.preventDefault();
			document.querySelector('.animate').focus();
...
function changeBg(){
	const inputStr = document.getElementById('bginput').value;
	const targetElement = document.getElementById('ele');
	targetElement.style.backgroundImage = `url('${inputStr}')`;
}
